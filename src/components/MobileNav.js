        ...
        <section
            ...
            <div id="tabs" className="flex justify-between">
                <button
                    ...
                    className={`justify-center inline-block transition-colors duration-150 w-full pt-2 pb-1 text-center ${
                    ...
                    <svg
                        ...
                        height="50"
                        viewBox="0 0 25 25"
                        className="inline-block mb-1 transform hover:scale-105">
                ...
                <button
                    ...
                    className={`justify-center inline-block w-full  transition-colors duration-150 pt-2 pb-1 text-center  ${
